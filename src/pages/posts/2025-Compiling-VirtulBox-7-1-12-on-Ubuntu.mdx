...
Though the official build instructions is out dated, but worth a look, [Linux build instructions](https://www.virtualbox.org/wiki/Linux%20build%20instructions)
